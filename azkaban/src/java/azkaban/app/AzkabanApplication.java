...
public class AzkabanApplication
{
  ...
  public AzkabanApplication(List<File> jobDirs, File logDir, File tempDir, boolean enableDevMode) throws IOException
  {
    ...
    _jobManager = new JobManager(
        ...
        _jobDirs,
        _baseClassLoader,
        Executors.newFixedThreadPool(defaultProps.getInt("azkaban.runner.threads", Runtime.getRuntime().availableProcessors()))
    );

    _mailer = new Mailman(
        defaultProps.getString("mail.host", "localhost"),
