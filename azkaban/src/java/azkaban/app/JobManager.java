...
public class JobManager
{
  ...
  private final ExecutorService jobExec;
  ...
  {
    Map<String, JobDescriptor> descriptors = loadJobDescriptors(
        overrides,
  ...
  */
  ...
  )
  {
    ...
    for (File file : _jobDirs) {
      Map<String, JobDescriptor> d = loadJobDescriptors(
          file,
          overrides,
          pathOverrides,
          ignoreDeps
   ...
   */
  protected Map<String, JobDescriptor> loadJobDescriptors(
      File jobDir,
  ...
  )
  {
    ...
    loadJobDescriptorsWithoutDependencies(
        m,
        jobDir,
        jobDir,
        _defaultProps,
  ...
  */
  ...
  public ExecutorService getJobExec()
  {
    return jobExec;
  }
  ...
  public void deployJobDir(String localPath, String destPath)
  {
    ...
    if (currPath.renameTo(targetPath)) {
      ...
      throw new RuntimeException(
          "Deploy failed because " + currPath
